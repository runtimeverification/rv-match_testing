...
set -e
function stopLxc {
  lxc-stop -n rv-match_regression_container
}
...
lxc-info --name rv-match_regression_container
lxc-start -n rv-match_regression_container
lxc-attach -n rv-match_regression_container -- su -l -c /mnt/jenkins/echohello_regression.sh
