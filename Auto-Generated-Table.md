...
| project | configure | make | open issues | closed issues | 
| --- | --- | --- | --- | --- | 
| bind9 | :grey_question: | :grey_question: |  | debugging table |
| bogosort | :grey_question: | :grey_question: |  | debugging table |
| cFE | :grey_question: | :grey_question: |  | debugging table |
| coreutils | :grey_question: | :grey_question: |  | debugging table |
| curve25519 | :grey_question: | :grey_question: |  | debugging table |
| dpkg | :grey_question: | :grey_question: |  | debugging table |
| FFmpeg | :grey_question: | :grey_question: |  | debugging table |
| hashcat | :grey_question: | :grey_question: |  | debugging table |
| helloworld | :grey_question: | :white_check_mark: |  | debugging table |
| hostapd | :grey_question: | :grey_question: |  | debugging table |
| libuv | :grey_question: | :grey_question: |  | debugging table |
| linux | :grey_question: | :grey_question: |  | debugging table |
| lua-5.3.4 | :grey_question: | :grey_question: |  | debugging table |
| mbedtls | :grey_question: | :grey_question: |  | debugging table |
| netdata | :white_check_mark: | :x: |  | debugging table |
| Open-Chargeport | :grey_question: | :grey_question: |  | debugging table |
| openssl | :grey_question: | :grey_question: |  | debugging table |
